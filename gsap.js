...
newDescHTML1 = `
        ...
        <button id="map_button" type="button" class="btn btn-secondary btn-lg active" style="margin-top: 85%; background-color: #141f2a; border-color:rgb(182, 194, 205); color: rgb(182, 194, 205); width: 100%;" onclick="replaceMap()">View by Sex</button>`;
newDescHTML2 = `
        ...
        <button id="map_button" type="button" class="btn btn-secondary btn-lg active" style="margin-top: 85%; background-color: #141f2a; border-color:rgb(182, 194, 205); color: rgb(182, 194, 205); width: 100%;" onclick="replaceMap()">View by Race</button>`;
